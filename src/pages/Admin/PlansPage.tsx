...
export default function PlansPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#F5F5F5]">
      <NavigationBar />
      <Toaster />
      <main className="flex-1 justify-between px-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-7">
            ...
            <div className="flex items-center gap-3 ml-[20rem]">
              <button className="px-6 py-2 mt-[1.8rem] bg-[#5B9B6B] text-white rounded-md 
              hover:bg-[#4A8A5A] transition-colors flex-1">
                Search
              </button>
              <button
                onClick={handleClear}
                className="px-6 py-2 mt-[1.8rem] border border-[#5B9B6B] text-[#5B9B6B] 
              ...
              <div className="flex gap-4 pt-4">
                ...
                <button
                  ...
                  onClick={() => {
                    setIsModalOpen(false);
                    setEditingPlan(null);
                    setNewPlan({ location: "", planName: "", price: "" }); // Clear the form
                    toast.error(
                      `${
